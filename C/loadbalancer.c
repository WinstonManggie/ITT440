...
int main(){
	...
	if(strcmp(client_message,"black")==0){

		serversocket1=socket(AF_INET,SOCK_STREAM,0);
		server1.sin_family=AF_INET;
		server1.sin_addr.s_addr=inet_addr("192.168.17.130");
	...
	close(serversocket1);
	}else if(strcmp(client_message,"white")==0){

		serversocket2=socket(AF_INET,SOCK_STREAM,0);
		server2.sin_family=AF_INET;
		server2.sin_addr.s_addr=inet_addr("192.168.17.129");
